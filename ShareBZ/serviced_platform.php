  ...
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          ...
          <li><a class="logout" href="newAccount.php">Sign-Up</a></li>
        </ul>
      </div>
      <?}?>
    </header>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li>
            <a class="active" href="serviced_platform.php">
              <i class="fa fa-desktop"></i>
          ...
          <div class="col-lg-12">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <div class="custom-box">
                ...
                <a class="btn btn-theme" href="./platform/airbnb.php">More detail</a>
              </div>
              <!-- end custombox -->
            </div>
            <!-- end col-4 -->
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <div class="custom-box">
                ...
                <a class="btn btn-theme" href="./platform/uber.php">More detail</a>
              </div>
              <!-- end custombox -->
            </div>
            <!-- end col-4 -->
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <div class="custom-box">
                ...
                <a class="btn btn-theme" href="./platform/wework.php">More detail</a>
              </div>
              <!-- end custombox -->
            </div>
            <!-- end col-4 -->
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="pricing_table.php#" class="go-top">
